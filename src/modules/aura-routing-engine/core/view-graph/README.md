...
**Безопасность:** `url`, bare `view` и `iframe::` используют значения из атрибутов маршрута без allowlist — разметка `<aura-route>` считается доверенной. См. [guide — Views](../../../../../docs/guide/03-views-and-layouts.md#views) · [SECURITY.md](../../../../../SECURITY.md).
