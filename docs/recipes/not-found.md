...
For custom unmatched-URL handling, use `router.setNotFoundHandler()` or the cancelable fallback `not-found` event. See [Custom 404 handling](../guide.md#custom-404-handling) for the precedence.
