...
> **Связанные документы:** [PLUGINS.md](../PLUGINS.md), [VIEW_TRANSITIONS_API.md](./VIEW_TRANSITIONS_API.md), [TRANSITION_PRESENTATION_CORE.md](./TRANSITION_PRESENTATION_CORE.md), [IN_PLACE_REMOUNT.md](./IN_PLACE_REMOUNT.md), [NAVIGATION_EVENTS.md](./NAVIGATION_EVENTS.md), [REPLACE_SUPERSEDE_ROLLBACK.md](./REPLACE_SUPERSEDE_ROLLBACK.md)
