...
import { hasFastPathLifecycleGates } from './can-use-fast-path';
 ...
 * Runtime cache fast-path probes: {@link ./can-use-fast-path}.
 */
...
export function finalizeTransitionPlan(base: TransitionPlanBase): TransitionMap {
  ...
  const canUseFastPath =
    ...
    && hasFastPathLifecycleGates(enterRoute, exitRoute);
